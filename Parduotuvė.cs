...
namespace _3uzd
{
    public class Parduotuvė
    {
        ...
        public string AtspausdintiAnalizę()
        {
            ...
            sb.AppendLine($"|{$"{(atėjoKlientųP1 - aptarnautaKlientųP1 == 1 ? "Neaptarnautas" : "Neaptarnauti")} {atėjoKlientųP1 - aptarnautaKlientųP1} {GaukKlientoŽymę(atėjoKlientųP1 - aptarnautaKlientųP1)}",-Protokolas.EILUTĖS_ILGIS + 2}|");
            ...
            sb.AppendLine($"|{$"{(atėjoKlientųP2 - aptarnautaKlientųP2 == 1 ? "Neaptarnautas" : "Neaptarnauti")} {atėjoKlientųP2 - aptarnautaKlientųP2} {GaukKlientoŽymę(atėjoKlientųP2 - aptarnautaKlientųP2)}",-Protokolas.EILUTĖS_ILGIS + 2}|");
